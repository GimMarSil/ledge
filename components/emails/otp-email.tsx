...
export const OTPEmail: React.FC<OTPEmailProps> = ({ otp }) => (
  <EmailLayout preview={`O seu código de verificação ${config.app.title}`}>
    <h2 style={{ textAlign: "center", color: "#00C2A8" }}>🔑 O seu código de verificação {config.app.title}</h2>
    <div
      style={{
        margin: "20px 0",
        padding: "20px",
